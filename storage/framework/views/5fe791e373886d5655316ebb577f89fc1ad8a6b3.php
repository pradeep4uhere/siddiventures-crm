      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php if($path=='/addmenu'){ ?> active <?php } ?> <?php if(strpos($path, 'menutype')!== false){ ?> active <?php } ?>">
         ...
         <li class="treeview 
          ...
          <ul class="treeview-menu">
           <li class="<?php if($path=='/alldslist'){ ?>selected <?php } ?>"><a class="nav-link" href="<?php echo e(route('alldslist')); ?>"><i class="fa fa-list"></i> All DS List</a></li>
           <li class="<?php if($path=='/allrolist'){ ?>selected <?php } ?>"><a class="nav-link" href="<?php echo e(route('allrolist')); ?>"><i class="fa fa-list"></i> All RO List</a></li>
         ...
         <li class="treeview 
          ...
          <ul class="treeview-menu">
           <li class="<?php if($path=='/alldslist'){ ?>selected <?php } ?>"><a class="nav-link" href="<?php echo e(route('alldslist')); ?>"><i class="fa fa-list"></i> All Request From DS</a></li>
           <li class="<?php if($path=='/alldslist'){ ?>selected <?php } ?>"><a class="nav-link" href="<?php echo e(route('alldslist')); ?>"><i class="fa fa-list"></i> All Request From RO</a></li>
...
<?php /**PATH /var/www/html/siddiventures.admin/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>