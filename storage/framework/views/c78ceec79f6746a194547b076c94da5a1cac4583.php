...
<head>
  ...
  <title>Reply From Aimbeyond</title>
  <!--[if !mso]>
      <!-- -->
...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 840px; border: 0" width="100%">
            <tr>
              <td id="templatePreheader" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color:#2b2a6d;
 ...
 <a href="<?php echo e($data['site_url']); ?>" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; color: #2a2a2a;
 font-weight: normal; text-decoration: none" target="_blank" title="Logo Image">
                                  <img align="none" alt="Image"  src="http://aimbeyond.com/images/abit_logo.png" style="-ms-interpolation-mode: bicubic; border: 0; outline: none;
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #f6faff;
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding:0px" valign="top">
                        <table align="left" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="border-collapse: collapse; mso-table-lspace: 0; mso-table-rspace: 0; -ms-text-size-adjust: 100%; -webkit-text-size-adjust:
 100%; min-width:100%;" width="100%" background-color="#f6faff">
                          <tbody>
                            <tr>
                              <td class="mcnImageContent" style="mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; padding-right: 0px; background-color: #f6faff;
 padding-left: 0px; padding-top: 0; padding-bottom: 0; text-align:center;" valign="top" background-color="#f6faff">
 ...
 100%; min-width:100%;" width="100%">
                          <tbody>
                            <tr>
                              <td class="mcnTextContent" style='mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
 color: #2a2a2a; font-family: "calibri", Helvetica, sans-serif; font-size: 16px;
 line-height: 150%; text-align: left; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Dear <?php echo $data['user_name']; ?>,
                                <br>
                            ...
                            <tr>
                              <td class="mcnTextContent" style='mso-line-height-rule: exactly;
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; word-break: break-word;
 color: #2a2a2a; font-family: "calibri", Helvetica, sans-serif; font-size: 12px;
 line-height: 150%; text-align: left; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                <p>If you want to reply about the same, please click on "Reply Here" button.</p>
                              </td>
                            </tr>
                          </tbody>
                        </table>
...
<tr>
 ...
 -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%; background-color: #e3e3e3;
 border-top: 0; border-bottom: 0; padding-top: 5px; padding-bottom: 10px" valign="top">
 ...
 padding-bottom: 10px; padding-left: 18px; color: #767676; font-family: 'Asap',
 Helvetica, sans-serif; font-size: 12px; padding-top: 5px;" valign="top">
                               
                                  <p style="padding-top: 0px">
                                    <img src="<?php echo e($data['logo']); ?>" style="vertical-align: middle;"> | Aimbeyond.   <img src="<?php echo e($data['fb']); ?>" style="vertical-align: middle;">&nbsp;&nbsp;<img src="<?php echo e($data['ln']); ?>" style="vertical-align: middle;">&nbsp;&nbsp;<img src="<?php echo e($data['gp']); ?>" style="vertical-align: middle;"><br/>
<img src="http://182.156.76.108:3000/images/indian-icon.png" style="vertical-align: middle;"><?php echo e($data['address_number_1']); ?><br/> 
Tel:+91.<?php echo e($data['office_number']); ?> | Fax: +91.<?php echo e($data['contact_mobile']); ?>

                                  </p>
                                   <div style="text-align: center;">
                                  
                                  © Copyright 2020 aimbeyond.com, All rights reserved.</div>
                              </td>
                            </tr>
                            <tbody></tbody>
                          </tbody>
...
</html><?php /**PATH /var/www/html/cms-content/resources/views/Email/JobReplyToUser.blade.php ENDPATH**/ ?>