                ...
                <div class="col-sm-12 col-md-6">
                  ...
                  <div class="col-sm-12 col-md-12">
                    ...
                    <textarea id="editor111" name="body" rows="10" cols="80" placeholder="Enter Page Content Description" class="jqte-test">
                      ...
                      <div class="col-sm-12 col-md-6">
                    <label for="inputPassword3" class="control-label">Page Box Order<small class="mendetetory">*</small></label>
...
<?php echo $__env->make('layouts.blankLayout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cms-content/resources/views/admin/Page/PageContent/editPageContentTemplate.blade.php ENDPATH**/ ?>