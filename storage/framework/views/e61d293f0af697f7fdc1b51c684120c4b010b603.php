  <section class="content">
                  ...
                  <div class="box-body">
                    <div class="form-group col-md-12">
                     <div class=" col-md-6">
                      <div class="">
                        ...
                        <input type="text" class="form-control" id="inputEmail3" placeholder="Enter Job Title" name="title" required="required" value="<?php echo e($jobDetails['job_title']); ?>">
                      </div>
                    </div>
                    <div class=" col-md-6">
                      <div class="">
                        <label for="inputPassword3" class=" control-label" name="slug"> JOB ID</label>
                        <input type="text" class="form-control" id="inputPassword3" placeholder="Job ID" name="jobid" required="required" value="<?php echo e($jobDetails['job_id']); ?>">
                      </div>
                    </div>
                      ...
                      <label for="inputPassword3" class=" control-label" name="slug"> Tag Line</label>
                        <input type="text" class="form-control" id="tagline" placeholder="Enter tage line" name="tagline"  value="<?php echo e($jobDetails['tagline']); ?>">
                      </div>
                     ...
                     <div class="form-group col-md-12">
                      ...
                      <div>
                        ...
                        <textarea id="editor1" name="body" rows="10" cols="60">
                          <?php echo e($jobDetails['job_descriptions']); ?>
                    ...
                    <div class="col-md-6">
                      <label for="inputPassword3" class=" control-label" name="slug"> External Url</label>
                        <input type="text" class="form-control" id="tagline" placeholder="Enter External Url" name="external_url"  value="<?php echo e($jobDetails['external_url']); ?>">
                      </div>
                  
                    <div class="col-md-6">
                      <div class="">
                      <label for="inputPassword3" class="control-label">Job Published</label>
                        <input type="date" name="job_publiish_date" class="form-control datepicker" value="<?php echo e($jobDetails['job_publish_date']); ?>">
                    </div>
                  </div>
    ...
    <!-- /.content -->   <?php /**PATH /var/www/html/cms-content/resources/views/admin/Job/editForm.blade.php ENDPATH**/ ?>