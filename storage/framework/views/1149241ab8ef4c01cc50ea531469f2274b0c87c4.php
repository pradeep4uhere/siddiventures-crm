      ...
      <ul class="sidebar-menu" data-widget="tree">
        ...
        <li class="treeview <?php if($path=='/addmenu'){ ?> active <?php } ?> <?php if(strpos($path, 'menutype')!== false){ ?> active <?php } ?>">
         ...
         <li class="treeview 
          ...
          <li class="treeview 
          <?php if(($path=='/addskill') || ($path=='/alljobskills') || ($path=='/editskill')){ ?> active <?php } ?>
" >
          <a href="#">
            <i class="fa fa-connectdevelop"></i>
            <span>Job Skill Management</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>
          <ul class="treeview-menu">
           <li class="<?php if($path=='/alljobskills'){ ?>selected <?php } ?>"><a class="nav-link" href="<?php echo e(route('alljobskills')); ?>"><i class="fa fa-list"></i> Job Skills</a></li>
           <li class="<?php if($path=='/addskill'){ ?>selected <?php } ?>"><a class="nav-link" href="<?php echo e(route('addskill')); ?>"><i class="fa fa-plus"></i> Add New Skill</a></li>

          </ul>
        </li>

        <li class="treeview 
          <?php if(($path=='/createjob') || ($path=='/alljobs') || ($path=='/editjob')){ ?> active <?php } ?>" >
          <a href="#">
          ...
          <ul class="treeview-menu">
           <li class="<?php if($path=='/alljobs'){ ?>selected <?php } ?>"><a class="nav-link" href="<?php echo e(route('alljobs')); ?>"><i class="fa fa-list"></i> All Jobs</a></li>
           <li class="<?php if($path=='/createjob'){ ?>selected <?php } ?>"><a class="nav-link" href="<?php echo e(route('createjob')); ?>"><i class="fa fa-plus"></i> Add New Job</a></li>

          </ul>
        </li>
         <li class="treeview 
          <?php if(($path=='/alljobsapplication')){ ?> active <?php } ?>
          <?php if(strpos($path, '/editapplication')!== false){ ?> active <?php } ?>
          " >
          <a href="#">
          ...
          <ul class="treeview-menu">
           <li class="
           <?php if($path=='/alljobsapplication'){ ?>selected <?php } ?>
            <?php if(strpos($path, '/editapplication')!== false){ ?> active <?php } ?>
           "><a class="nav-link" href="<?php echo e(route('alljobsapplication')); ?>"><i class="fa fa-list"></i> All Applied Job</a></li>
...
<?php /**PATH /var/www/html/cms-content/resources/views/layouts/sidebar.blade.php ENDPATH**/ ?>