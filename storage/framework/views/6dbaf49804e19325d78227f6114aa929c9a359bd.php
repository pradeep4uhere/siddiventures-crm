            ...
            <div class="container-fluid">
                <a href="http://182.156.76.108/cms-content/public/index.php" class="navbar-brand">
                     <div class="logo-lg text-c" style="background-color: #FFF; padding-top: 7px;">
                        <img height="38px" src="<?php echo e(config('global.BACKENDCMS')); ?>/Admin/dist/img/rsz_logo_1.png">
                    </div>
                </a> 
...
</html><?php /**PATH /var/www/html/debaleenacms/resources/views/layouts/app.blade.php ENDPATH**/ ?>