...
<header class="main-header">
    ...
    <a href="<?php echo e(env('APP_URL')); ?>" class="logo" style="background-color: #FFF;">
      ...
      <span class="logo-lg" style="background-color: #FFF; padding-top: 7px;"><img height="38px" src="<?php echo e(config('global.BACKENDCMS')); ?>/Admin/dist/img/abit_logo.png"></span>
    </a>
...
<?php /**PATH /var/www/html/cms-content/resources/views/layouts/header.blade.php ENDPATH**/ ?>