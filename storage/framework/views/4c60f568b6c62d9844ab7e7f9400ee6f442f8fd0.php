          ...
          <!-- Horizontal Form -->
            ...
            <form class="form-horizontal" action="<?php echo e(route('editapplication',['id'=>$menu['id']])); ?>" method="post" >
              ...
              <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="form-group">
                  ...
                  <input type="text" class="form-control" id="when_start"  name="when_start" value="<?php echo e($menu['when_start']); ?>">
                </div>
              ...
              <div class="box-footer">
                ...
                <button type="submit" class="btn btn-danger pull-right"  style="margin-right:5px; ">Cancel</button>
              </div>
              <!-- /.box-footer -->
            </form>
          <!-- /.box -->
...
<?php echo $__env->make('layouts.addpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cms-content/resources/views/admin/Job/Jobapplication/edit.blade.php ENDPATH**/ ?>