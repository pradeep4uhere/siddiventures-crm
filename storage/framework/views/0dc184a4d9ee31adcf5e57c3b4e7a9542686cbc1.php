...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/bootstrap/dist/css/bootstrap.min.css">
        <!-- DataTables -->
        <!-- DataTables -->
    <link rel="stylesheet" href="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/datatables.net-bs/css/dataTables.bootstrap.min.css">
    ...
    <link rel="stylesheet" href="<?php echo e(config('global.BACKENDCMS')); ?>/backend/plugins/iCheck/all.css">
   <!-- jvectormap -->
    <link rel="stylesheet" href="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/jvectormap/jquery-jvectormap.css">

     <!-- Select2 -->
  <link rel="stylesheet" href="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/select2/dist/css/select2.min.css">
    <!-- Theme style -->
...
<!-- FastClick -->
<!-- Select2 -->
<script src="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/select2/dist/js/select2.full.min.js"></script>
<!-- InputMask -->
<!-- DataTables -->
<script src="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/datatables.net/js/jquery.dataTables.min.js"></script>
<script src="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/datatables.net-bs/js/dataTables.bootstrap.min.js"></script>
<!-- SlimScroll -->
...
<!-- date-range-picker -->
<script src="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/moment/min/moment.min.js"></script>
<script src="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/bootstrap-daterangepicker/daterangepicker.js"></script>
<!-- bootstrap datepicker -->
<script src="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/bootstrap-datepicker/dist/js/bootstrap-datepicker.min.js"></script>
...
<!-- AdminLTE App -->
<script src="<?php echo e(config('global.BACKENDCMS')); ?>/backend/bower_components/dist/js/adminlte.min.js"></script>
...
<?php /**PATH /var/www/html/cms-content/resources/views/layouts/addjob.blade.php ENDPATH**/ ?>