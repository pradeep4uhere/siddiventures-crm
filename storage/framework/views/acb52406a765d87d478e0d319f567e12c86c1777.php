...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      ...
      <ol class="breadcrumb">
        <li><a  href="<?php echo e(route('alljobskills')); ?>">All Skill List</a></li>
      </ol>
    </section>
    <!-- Main content -->
      ...
      <div class="row">
        ...
        <div class="col-md-10">
          <!-- Horizontal Form -->
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="<?php echo e(route('editskill',['id'=>$menu['id']])); ?>" method="post" >
...
<?php echo $__env->make('layouts.addpage', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH /var/www/html/cms-content/resources/views/admin/Job/Skill/edit.blade.php ENDPATH**/ ?>