...
<section class="content-header">
  <h1>View {{$jobDetails['job_title']}} Job</h1>
  <ol class="breadcrumb">
   ...
   <section class="content">
            ...
            <div class="box-body">
              ...
              <table class="table table-striped">
                <tr>
                  ...
                  <td nowrap="nowrap"> {{$jobDetails['job_title']}}</td>
                  <td>
                    <b>Job ID:</b>
                  </td>
                ...
                <tr>
                 ...
                 <tr>
                  <td colspan="4"> {!!$jobDetails['job_descriptions']!!}</td>
                </tr>
                <tr>
                  <td nowrap="nowrap"><b>External Url:</b></td>
                  <td> {{$jobDetails['external_url']}}</td>
                  <td nowrap="nowrap">
                    <b>Job Published:</b>
                  </td nowrap="nowrap">
                  <td>{{GeneralHelper::getDateFormate($jobDetails['job_publish_date'])}}</td>
                </tr>
    ...
    @include('admin.Job.AllAppliedApplicationList',array('List'=>$List,'Job'=>$jobDetails))
    </div>
