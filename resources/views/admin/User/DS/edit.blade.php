...
<!-- Content Wrapper. Contains page content -->
  <div class="content-wrapper">
    ...
    <section class="content-header">
      <h1>Edit DS - {{$user['first_name']}}</h1>
      <ol class="breadcrumb">
        <li><a  href="{{ route('alldslist') }}">All DS List</a></li>
      </ol>
    </section>
    <!-- Main content -->
        ...
        <div class="col-md-12">
          <!-- Horizontal Form -->
            <div class="box-header with-border">
              <h3 class="box-title">Enter DS Details</h3>
            </div>
            <!-- /.box-header -->
            <!-- form start -->
            <form class="form-horizontal" action="{{route('editds',['id'=>$user['id']])}}" method="post" enctype="multipart/form-data">
              {{csrf_field()}}
              <div class="box-body">
