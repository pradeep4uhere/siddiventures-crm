              ...
              <div class="box-body">
                <div class="form-group">
                  ...
                  <div class="col-sm-12 col-md-6">
                    <label for="inputEmail3" class="control-label">Parent Menu</label>
                    ...
                    <div class="col-sm-12 col-md-6">
                  <label for="inputPassword3" class=" control-label">Enter New Menu</label>
                  ...
                  <div class="col-sm-12 col-md-6">
                    <label for="inputPassword3" class="control-label">Position</label>
