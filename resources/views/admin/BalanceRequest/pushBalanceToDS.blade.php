          ...
          <div class="box box-info">
            ...
            <div class="box-body">
              <div class="table-responsive">
                <!-- right column -->
              <div class="col-md-12">
              <form class="form-horizontal" action="{{route('pushbalancetods',['id'=>$DsWalletBalance['id']])}}" method="post" enctype="multipart/form-data">
                {{csrf_field()}}
                 @include('admin.BalanceRequest.pushBalanceToDSBody')
              </form>
              <!-- /.box -->
              </div>
              </div>
