...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 line-height: 150%; text-align: left; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Dear {!!$data['user_name']!!},
                                <br>
                                 {!!$data['reply_message']!!}
                              </td>
                            </tr>
...
<tr>
 ...
 Helvetica, sans-serif; font-size: 12px; padding-top: 5px;" valign="top">
                                  ...
                                  <p style="padding-top: 0px">
                                    <img src="{{$data['logo']}}" style="vertical-align: middle;"> | Aimbeyond.   <img src="{{$data['fb']}}" style="vertical-align: middle;">&nbsp;&nbsp;<img src="{{$data['ln']}}" style="vertical-align: middle;">&nbsp;&nbsp;<img src="{{$data['gp']}}" style="vertical-align: middle;"><br/>
<img src="http://182.156.76.108:3000/images/indian-icon.png" style="vertical-align: middle;">{{$data['address_number_1']}}<br/> 
Tel:+91.{{$data['office_number']}} | Fax: +91.{{$data['contact_mobile']}}
                                  </p>
