...
<body style="-ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 ...
 color: #2a2a2a; font-family: "calibri", Helvetica, sans-serif; font-size: 14px;
 line-height: 150%; text-align: left; padding-top:9px; padding-right: 18px;
 padding-bottom: 9px; padding-left: 18px;' valign="top">Dear {!!$data['greeting_name']!!},
                                <br>
                                 <p style="font-size: 14px;">
                                  Please refer to the new job application below :
                                </p>
                              </td>
                            </tr>
                            <tr>
 ...
 padding-bottom: 9px; padding-left: 18px;' valign="top">
                                ...
                                <table cellpadding="5" cellspacing="5" border="0" style="font-size: 14px;">
                                  <tr>
                                    <td nowrap="nowrap" style="width: 100px;font-size: 14px;">Name</td>
                                    <td style="width: 5px;">:</td>
                                    <td style="text-align: left;" align="left">{{$data['user_name']}}</td>
                                  </tr>
                                  <tr>
                                    <td nowrap="nowrap" style="width: 100px;font-size: 14px;">Email Address</td>
                                    <td style="width: 5px;">:</td>
                                    <td style="text-align: left;" align="left">{{$data['user_email_address']}}</td>
                                  </tr>
                                  <tr>
                                    <td nowrap="nowrap" style="width: 100px;font-size: 14px;">Mobile Number</td>
                                    <td style="width: 5px;">:</td>
                                    <td style="text-align: left;" align="left">{{$data['mobile']}}</td>
                                  </tr>
                                  <tr>
                                    <td nowrap="nowrap" style="width: 100px;font-size: 14px;">Job Title</td>
                                    <td style="width: 5px;">:</td>
                                    <td style="text-align: left;" align="left">{{$data['job_name']}}</td>
                                  </tr>
                                  <tr>
                                    <td nowrap="nowrap" style="width: 100px;font-size: 14px;">When Start</td>
                                    <td style="width: 5px;">:</td>
                                    <td style="text-align: left;" align="left">{{$data['when_start']}}</td>
                                  </tr>
                                  <tr>
                                    <td nowrap="nowrap" style="width: 100px;vertical-align: top;font-size: 14px;">Cover Letter</td>
                                    <td style="width: 5px;">:</td>
                                    <td style="font-size: 14px;text-align: left;" align="left">{!!$data['cover_letter']!!}</td>
                                  </tr>
                                </table>
                              </td>
                            </tr>
 ...
 exactly; -ms-text-size-adjust: 100%; -webkit-text-size-adjust: 100%;
 font-family: 'calibri', Helvetica, sans-serif; font-size: 14px; padding-top:15px;
 padding-right:20px; padding-bottom:15px; padding-left:20px;" valign="middle">
                                        <a class="mcnButton " href="{{$data['resume']}}" style="mso-line-height-rule: exactly;
 ...
 #FFFFFF; text-transform:uppercase;" target="_blank" title="Download Resume">Download Resume</a>
                                      </td>
                                    </tr>
                                  </tbody>
                                </table>
