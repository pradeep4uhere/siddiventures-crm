...
<link type="text/css" rel="stylesheet" href="{{config('global.BACKENDCMS')}}/backend/jquery-te-1.4.0.css">
...
<script type="text/javascript" src="{{config('global.BACKENDCMS')}}/backend/jquery-te-1.4.0.js" charset="utf-8"></script>
